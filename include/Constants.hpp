...
const std::vector<std::pair<std::string, float>> propsList = {
    {"beer_bottle.glb", 0.008f},       {"plastic_water_bottle.glb", 0.01f}, {"watermelon.glb", 0.02f},
    {"bottle_of_champagne.glb", 1.1f}, {"shampoo_bottle.glb", 1.0f},        {"heiniken_bottle.glb", 0.1f},
};
